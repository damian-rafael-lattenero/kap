    ...
    "KAP JMH Benchmarks": [
      {
        "commit": {
          ...
          "distinct": true,
          "id": "207e2b01eec92877d79af15dc151bf86a16e0ede",
          "message": "refactor: remove Async object, rename await() to executeGraph()\n\nSimplify the KAP API by removing the Async {} wrapper and the @AsyncDsl\nannotation. The new entry point is a single extension function\nKap<A>.executeGraph() that creates a coroutineScope and executes the\ncomputation graph with full structured concurrency guarantees.\n\nBefore:\n  val result = Async {\n      kap(::Dashboard)\n          .with { fetchUser() }\n          .with { fetchCart() }\n  }\n\nAfter:\n  val result = kap(::Dashboard)\n      .with { fetchUser() }\n      .with { fetchCart() }\n      .executeGraph()\n\nThis removes one concept from the public API, makes the DSL fully\nchainable, and gives the terminal operator a name that reflects graph\nexecution semantics rather than coroutine awaiting.",
          "timestamp": "2026-04-02T20:29:29-03:00",
          "tree_id": "cb4eeb491e96eef6ce57fad12c73018606918bc0",
          "url": "https://github.com/damian-rafael-lattenero/kap/commit/207e2b01eec92877d79af15dc151bf86a16e0ede"
        },
        "date": 1775176835850,
        "tool": "jmh",
        "benches": [
