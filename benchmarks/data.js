    ...
    "KAP JMH Benchmarks": [
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c5cef324a9111484ffd7e5c68ba1134075fa619d",
          "message": "test: exhaustive test suite for kapTyped() and opaque types\n\nAdd 17 new tests covering kapTyped() entry point with opaque types:\n- kapTyped with 2 and 5 params\n- Parallel execution via kapTyped\n- Phase barriers (then) with opaque types\n- Composition: andThen, map, recover, settled, memoize\n- Error propagation and cancellation\n- kapTyped for annotated functions (kapTypedBuildGreeting)\n- kapTyped for prefixed functions (kapTypedBuildA)\n- Nullable and generic opaque types\n- @KapBridge third-party class with kapTyped\n- Mixed usage: named builders + kapTyped produce identical results\n- Chaining named builders and opaque types via andThen\n\nTotal: 44 tests (43 KapTypeSafe + 1 collision).",
          "timestamp": "2026-04-03T17:03:13-03:00",
          "tree_id": "639f740c4f79e8c196bfb59cde094d7b6fc6d9e7",
          "url": "https://github.com/damian-rafael-lattenero/kap/commit/c5cef324a9111484ffd7e5c68ba1134075fa619d"
        },
        "date": 1775250685598,
        "tool": "jmh",
        "benches": [
